...
def detect_anagrams(anagram, listanagram):
    goodword = []
    sortedAnagram = sorted(anagram.lower())
    for n in listanagram:
        if sorted(n.lower()) == sortedAnagram and n.lower() != anagram.lower():
            goodword.append(n)
    return goodword
